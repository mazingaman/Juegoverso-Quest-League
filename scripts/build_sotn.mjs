...
// Usa fetch nativo de Node 20 (sin dependencias).
...
const trDesc = (d='') => {
  const map = [
    ["Defeat","Derrota a"],["Find","Encuentra"],["Acquire","Obtén"],["Obtain","Obtén"],
    ["Reach","Alcanza"],["Train","Entrena"],["Perform","Realiza"],["Activate","Activa"],
    ["Finish","Termina"],["Use","Usa"],["Kill","Elimina"],
    ...
    ["Reverse Colosseum","Coliseo Invertido"],["Reverse Caverns","Cavernas Invertidas"],
...
async function main() {
  ...
  lines.push(`\n## Índice\n`);
  for (const a of ach) lines.push(`- [${trTitle(a.Title)}](#${slug(a.Title)})`);
  lines.push(`\n---\n`);
